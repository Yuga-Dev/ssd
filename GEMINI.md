...
**Core Value:** The suspense and social deduction of finding the imposter based on word clues, completely managed by the system without the host knowing the truth.
<!-- GSD:project-end -->
